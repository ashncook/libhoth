 ...
 protected:
  void SetUp() override {
    ...
    std::string template_str =
        std::string(build_root) + "/htool_security_tokens_test_dir.XXXXXX";
...
TEST_F(HtoolSecurityTokensTest, GetTokensInSetSuccess) {
  ...
  std::string tmp_output_file =
      std::string(tmp_dir) + "/tokens.GetTokensInSetSuccess.bin";
  std::string tmp_boot_nonce_file =
      std::string(tmp_dir) + "/boot_nonce.GetTokensInSetSuccess.bin";
  std::string tmp_signature_file =
      std::string(tmp_dir) + "/signature.GetTokensInSetSuccess.bin";
...
TEST_F(HtoolSecurityTokensTest, GetTokensInSetCommandFailure) {
  struct htool_invocation inv {};
  std::string tmp_output_file = std::string(tmp_dir) + "/tokens.GetTokensInSetCommandFailure.bin";
  std::string tmp_signature_file = std::string(tmp_dir) + "/signature.GetTokensInSetCommandFailure.bin";
  std::string tmp_boot_nonce_file = std::string(tmp_dir) + "/boot_nonce.GetTokensInSetCommandFailure.bin";
...
TEST_F(HtoolSecurityTokensTest, GetTokenSetCountSuccess) {
  struct htool_invocation inv {};
  std::string num_ids_file = std::string(tmp_dir) + "/num_ids.bin";
  std::string boot_nonce_file = std::string(tmp_dir) + "/boot_nonce.bin";
  std::string signature_file = std::string(tmp_dir) + "/signature.bin";
...
TEST_F(HtoolSecurityTokensTest, GetTokenSetCountCommandFailure) {
  struct htool_invocation inv {};
  std::string num_ids_file = std::string(tmp_dir) + "/num_ids.GetTokenSetCountCommandFailure.bin";
  std::string boot_nonce_file = std::string(tmp_dir) + "/boot_nonce.GetTokenSetCountCommandFailure.bin";
  std::string signature_file = std::string(tmp_dir) + "/signature.GetTokenSetCountCommandFailure.bin";
...
TEST_F(HtoolSecurityTokensTest, GetTokenSetInfoSuccess) {
  ...
  std::string tmp_info_file =
      std::string(tmp_dir) + "/info.GetTokenSetInfoSuccess.bin";
...
TEST_F(HtoolSecurityTokensTest, GetTokenSetInfoCommandFailure) {
  struct htool_invocation inv {};
  std::string tmp_info_file = std::string(tmp_dir) + "/info.GetTokenSetInfoCommandFailure.bin";
